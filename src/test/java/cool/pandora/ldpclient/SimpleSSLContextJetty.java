 ...
 */
public class SimpleSSLContextJetty {
     ...
     */
    public SimpleSSLContextJetty() throws IOException {
        init(SimpleSSLContextJetty.class.getResourceAsStream("/keystore/keystore"));
    }
     ...
     * @throws IOException ioexception
     */
    public SimpleSSLContextJetty(final String dir) throws IOException {
    ...
    private void init(final InputStream i) throws IOException {
        try {
            final char[] passphrase = "storepwd".toCharArray();
